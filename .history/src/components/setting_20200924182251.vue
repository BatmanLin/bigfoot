  ...
  <div>
    ...
    <div>
      <el-table id="channelTable" v-if="switchTableFlag" :data="allChannels">
        ...
        <el-table-column label="播放类型" prop="displayType"></el-table-column>
        <el-table-column label="所属设备" prop="devName"></el-table-column>
        <el-table-column label="所在位置" prop="channelName"></el-table-column>
        <el-table-column label="所属区域" prop="areas"></el-table-column>
        <el-table-column label="是否关联摄像头" prop="cameraExist"></el-table-column>
        <el-table-column label="操作">
          <template v-slot="scope">
            <div>
              <el-button @click="updateChannelsName(scope.row)">修改位置</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <el-dialog :visible.sync="dialogCheckVisible" title="查看设备" width="400px">
      <el-form :model="checkForm" label-width="120px" label-position="left" :inline="true">
        ...
        <el-form-item label="设备用户" prop="devAdmin" v-if="dialogDisplayType">
          <el-input v-model="checkForm.devAdmin" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备密码" prop="devPassword" v-if="dialogDisplayType">
          <el-input v-model="checkForm.devPassword" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备IP" prop="devIP" v-if="dialogDisplayType">
          <el-input v-model="checkForm.devIP" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备端口号" prop="devPort" v-if="dialogDisplayType">
          <el-input v-model="checkForm.devPort" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备序列号" prop="devSerial" v-if="dialogDisplayType">
          <el-input v-model="checkForm.devSerial" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备验证码" prop="validateCode" v-if="dialogDisplayType">
          <el-input v-model="checkForm.validateCode" disabled v-if="dialogDisplayType"></el-input>
        </el-form-item>
    ...
    <el-dialog :visible.sync="dialogAddVisible" title="添加设备" width="400px">
      <el-form :model="addDevInfor" label-width="120px" label-position="right" :inline="true" :rules="rules">
        <el-form-item label="设备id" prop="devID" v-if="commonInputFlag">
          <el-input v-model="addDevInfor.devID" width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备类型" prop="displayType">
          <el-select v-model="addDevInfor.displayType" placeholder="请选择" @change="changeDevInput">
            <el-option label="H5stream" value="H5stream"></el-option>
            <el-option label="YSCloud" value="YSCloud"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="设备名" prop="devName" v-if="commonInputFlag">
          <el-input v-model="addDevInfor.devName"></el-input>
        </el-form-item>
        <el-form-item label="设备用户" prop="admin" v-if="H5streamInputFlag">
          <el-input v-model="addDevInfor.admin"></el-input>
        </el-form-item>
        <el-form-item label="设备密码" prop="password" v-if="H5streamInputFlag">
          <el-input v-model="addDevInfor.password" :disabled="!H5streamInputFlag"></el-input>
        </el-form-item>
        <el-form-item label="设备IP" prop="devIP" v-if="H5streamInputFlag">
          <el-input v-model="addDevInfor.devIP" :disabled="!H5streamInputFlag"></el-input>
        </el-form-item>
        <el-form-item label="设备端口号" prop="devPort" v-if="H5streamInputFlag">
          <el-input v-model="addDevInfor.devPort" :disabled="!H5streamInputFlag"></el-input>
        </el-form-item>
        <el-form-item label="设备序列号" prop="devSerial" v-if="YSInputFlag">
          <el-input v-model="addDevInfor.devSerial"></el-input>
        </el-form-item>
        <el-form-item label="设备验证码" prop="validateCode" v-if="YSInputFlag">
          <el-input v-model="addDevInfor.validateCode"></el-input>
        </el-form-item>
      </el-form>
      <div>
        <el-button @click="dialogAddVisible=false">取消</el-button>
        <el-button @click="addDevice">确认</el-button>
      </div>
    </el-dialog>
    <el-dialog :visible.sync="dialogUpdateVisible" title="更新设备" width="400px">
    ...
    <el-dialog :visible.sync="dialogUpdateChannelVisible" title="更新通道" width="400px">
      <el-form :model="targetChannels" label-width="120px" label-position="left" :inline="true">
        <el-form-item label="设备id" prop="devID">
          <el-input v-model="targetChannels.devID" disabled></el-input>
        </el-form-item>
        <el-form-item label="所属区域" prop="displayType">
          <el-input v-model="targetChannels.areas"></el-input>
        </el-form-item>
        <el-form-item label="所在位置" prop="devName">
          <el-input v-model="targetChannels.channelName"></el-input>
        </el-form-item>
      </el-form>
      <div>
        <el-button @click="updateChannelInfor(targetChannels.areas, targetChannels.channelName, targetChannels.devID)">确定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    this.getAccessToken();
    await this.getAllDevInfor();
    await this.nvrChannelsCamerasNum();
  ...
  methods: {
    ...
    async nvrChannelsCamerasNum() {
      console.log(2222, this.allDevInfor.length);
    ...
    checkDialog(checkInfo) {
      console.log(111, checkInfo);
      if (checkInfo.displayType ==="YSCloud") {
       this.dialogDisplayType = false; 
      } else {
        this.dialogDisplayType = true;
      }
