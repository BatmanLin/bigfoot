<template>
  <div>
    ...
    <el-table id="channelTable" v-if="switchTableFlag" :data="allChannels">
      ...
      <el-table-column label="播放类型" prop="displayType"></el-table-column>
      <el-table-column label="所属设备" prop="devName"></el-table-column>
      <el-table-column label="所属区域" prop="areas">1111</el-table-column>
      <el-table-column label="所在位置" prop="channelName">1111</el-table-column>
      <el-table-column label="是否关联摄像头" prop="areas">1111</el-table-column>
      <el-table-column label="操作">
        <template>
          <div>
