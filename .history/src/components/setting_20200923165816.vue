    ...
    <el-dialog :visible.sync="dialogCheckVisible">
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devID">
          <el-input v-model="checkForm.devID" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="displayType">
          <el-input v-model="checkForm.displayType" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devName">
          <el-input v-model="checkForm.devName" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devAdmin">
          <el-input v-model="checkForm.devAdmin" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devPassword">
          <el-input v-model="checkForm.devPassword" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devIP">
          <el-input v-model="checkForm.devIP" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devPort">
          <el-input v-model="checkForm.devPort" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="devSerial">
          <el-input v-model="checkForm.devSerial" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="validateCode">
          <el-input v-model="checkForm.validateCode" disabled></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="checkForm">
        <el-form-item label="设备id" prop="cameraNum">
