<template>
  <div>
    ...
    <el-dialog :visible.sync="dialogAddVisible">
      <el-form :model="addDevInfor" label-width="120px" label-position="left" :inline="true" :rules="rules">
        <el-form-item label="设备id" prop="devID">
          <el-input v-model="addDevInfor.devID" disabled width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备类型" prop="displayType">
          <el-input v-model="addDevInfor.displayType" disabled width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备名" prop="devName">
          <el-input v-model="addDevInfor.devName" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备用户" prop="devAdmin">
          <el-input v-model="addDevInfor.devAdmin" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备密码" prop="devPassword">
          <el-input v-model="addDevInfor.devPassword" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备IP" prop="devIP">
          <el-input v-model="addDevInfor.devIP" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备端口号" prop="devPort">
          <el-input v-model="addDevInfor.devPort" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备序列号" prop="devSerial">
          <el-input v-model="addDevInfor.devSerial" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备验证码" prop="validateCode">
          <el-input v-model="addDevInfor.validateCode" disabled></el-input>
        </el-form-item>
        <el-form-item label="摄像头数量" prop="cameraNum">
          <el-input v-model="addDevInfor.cameraNum" disabled></el-input>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
