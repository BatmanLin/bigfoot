<template>
  <div>
    <el-button>切换表格</el-button>
    <el-button>导出</el-button>
    <el-button>点击上传</el-button>
    <el-button>更新数据</el-button>
    <el-table :data="allDevInfor">
      <el-table-column label="设备ID" prop=""></el-table-column>
      <el-table-column label="播放类型"></el-table-column>
      <el-table-column label="所属设备"></el-table-column>
