  ...
  <div>
    ...
    <el-dialog :visible.sync="dialogUpdateChannelVisible">
      <el-form :model="targetChannels" label-width="120px" label-position="left" :inline="true">
        <el-form-item label="设备id" prop="devID">
          <el-input v-model="targetChannels.devID" disabled width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备类型" prop="displayType">
          <el-input v-model="targetChannels.displayType" disabled width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备名" prop="devName">
          <el-input v-model="targetChannels.devName" disabled></el-input>
        </el-form-item>
        <el-form-item label="设备用户" prop="devAdmin">
          <el-input v-model="checkForm.devAdmin" disabled></el-input>
        </el-form-item>
