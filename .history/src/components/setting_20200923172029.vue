  ...
  <div>
    ...
    <el-dialog :visible.sync="dialogAddVisible">
      <el-form :model="addDevInfor" label-width="120px" label-position="right" :inline="true" :rules="rules">
        ...
        <el-form-item label="设备类型" prop="displayType">
          <el-input v-model="addDevInfor.displayType" width="400px"></el-input>
        </el-form-item>
        <el-form-item label="设备名" prop="devName">
        ...
        <el-form-item label="设备序列号" prop="devSerial">
          <el-input v-model="addDevInfor.devSerial" :disabled="!H5streamInputFlag"></el-input>
        </el-form-item>
        <el-form-item label="设备验证码" prop="validateCode">
          <el-input v-model="addDevInfor.validateCode" :disabled="!H5streamInputFlag"></el-input>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
